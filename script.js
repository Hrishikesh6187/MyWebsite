...
const experienceData = [
    {
        ...
        achievements: [
            ...
            'Implemented secure authentication systems with JWT tokens and protected sensitive user data using AES – 256 encryption via the Android javax.crypto library.',
